#! /home/lcz/code/lede/staging_dir/host/bin/bash
# --------------------------------------------------------------------- #
#
...
VG_PRG=""
VG_ARGS="--tool=memcheck --num-callers=20 --leak-check=yes --leak-resolution=high --show-reachable=yes --suppressions=./suppressions.supp"
