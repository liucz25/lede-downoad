...
am_rel_srcdir='.'
am_top_srcdir='/home/lcz/code/lede/build_dir/host/automake-1.15.1'
am_top_builddir='/home/lcz/code/lede/build_dir/host/automake-1.15.1'
...
case ${am_running_installcheck:=no} in
  yes)
    am_amdir='/home/lcz/code/lede/staging_dir/host/share/automake-1.15/am'
    am_automake_acdir='/home/lcz/code/lede/staging_dir/host/share/aclocal-1.15'
    am_bindir='/home/lcz/code/lede/staging_dir/host/bin'
    am_datadir='/home/lcz/code/lede/staging_dir/host/share'
    am_docdir='/home/lcz/code/lede/staging_dir/host/share/doc/automake'
    am_pkgvdatadir='/home/lcz/code/lede/staging_dir/host/share/automake-1.15'
    am_scriptdir='/home/lcz/code/lede/staging_dir/host/share/automake-1.15'
    am_system_acdir='/home/lcz/code/lede/staging_dir/host/share/aclocal'
    ;;
  no)
...
host_alias=${host_alias-'x86_64-pc-linux-gnu'}; export host_alias
...
AM_TEST_RUNNER_SHELL=${AM_TEST_RUNNER_SHELL-'bash'}
...
# e.g., $SHELL=/bin/tcsh).
SHELL=${AM_TESTSUITE_SHELL-'/usr/bin/env bash'}; export SHELL
...
EGREP=${AM_TESTSUITE_EGREP-'/home/lcz/code/lede/staging_dir/host/bin/grep -E'}
FGREP=${AM_TESTSUITE_FGREP-'/home/lcz/code/lede/staging_dir/host/bin/grep -F'}
...
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  CC=${AM_TESTSUITE_CC-${CC-'gcc'}}
else
  CC=$am_testaux_builddir/cc-no-c-o
fi
CXX=${AM_TESTSUITE_CXX-${CXX-'g++'}}
F77=${AM_TESTSUITE_F77-${F77-'false'}}
FC=${AM_TESTSUITE_FC-${FC-'false'}}
CFLAGS=${AM_TESTSUITE_CFLAGS-${CFLAGS-'-O2 -I/home/lcz/code/lede/staging_dir/host/include '}}
CXXFLAGS=${AM_TESTSUITE_CXXFLAGS-${CXXFLAGS-'-g -O2'}}
FCFLAGS=${AM_TESTSUITE_FCFLAGS-${FCFLAGS-''}}
FFLAGS=${AM_TESTSUITE_FFLAGS-${FFLAGS-''}}
CPPFLAGS=${AM_TESTSUITE_CPPFLAGS-${CPPFLAGS-'-I/home/lcz/code/lede/staging_dir/host/include '}}

# GNU compilers and their flags.
if test $AM_TESTSUITE_SIMULATING_NO_CC_C_O = no; then
  GNU_CC=${AM_TESTSUITE_GNU_CC-${GNU_CC-'gcc'}}
else
...
GNU_CFLAGS=${AM_TESTSUITE_GNU_CFLAGS-${GNU_CFLAGS-'-O2 -I/home/lcz/code/lede/staging_dir/host/include '}}
